...
&nbsp;This application is a single-page application (SPA) developed using JavaScript, SASS, HTML, and Webpack. Initially, the app framework was created using only HTML and SASS. Later on, JavaScript was implemented using webpack.
...
(World Heart is my imaginary NGO 🤭)
<br />
<br />
